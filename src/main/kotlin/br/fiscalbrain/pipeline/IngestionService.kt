...
class IngestionService(
    ...
    private fun fetchContent(sourceUrl: String): String {
        val validatedUrl = validateAndSanitizeSourceUrl(sourceUrl)
    ...
    private fun validateAndSanitizeSourceUrl(rawSourceUrl: String): String {
        val uri = try {
        ...
        if (resolved.any { isDeniedAddress(it) }) {
